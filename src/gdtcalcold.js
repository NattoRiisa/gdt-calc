...
var topics = [
  ...
  ["Colonize", 0.7, 0.6, 0.6, 1.0, 1.0, 0.7, 0.7, 1.0, 0.8],
  ...
  ["Farming", 0.6, 0.7, 1.0, 1.0, 0.8, 0.9, 0.9, 1.0, 0.8],
...
var platforms = [
  ...
  ["G64", 0.9, 1, 0.9, 0.9, 1, 0.7, 0.8, 0.9, 1.0, 1],
  ...
  ["Vena Oasis", 1, 0.8, 0.8, 0.9, 0.6, 0.7, 0.8, 1.0, 0.9],
  ["Super TES", 0.9, 0.9, 0.9, 1, 0.7, 0.9, 1, 0.9, 0.7, 3],
  ["PlaySystem", 1, 0.8, 1, 0.9, 0.7, 0.6, 0.8, 1, 0.9, 3],
  ["TES 64", 0.9, 0.8, 0.7, 0.8, 0.7, 0.9, 1, 0.9, 0.9, 3],
  ["DreamVast", 1, 0.7, 0.8, 1, 0.7, 0.7, 0.7, 1, 1, 4],
  ["PlaySystem 2", 1, 0.8, 1, 0.9, 0.7, 0.9, 0.9, 1, 0.8, 4],
  ["mBox", 1, 0.8, 0.9, 0.9, 0.7, 0.7, 0.8, 1, 0.9, 4],
  ["Game Sphere", 0.8, 0.8, 0.7, 0.8, 0.7, 1, 0.9, 0.9, 0.8, 3],
  ["GS", 0.9, 0.9, 1, 0.9, 0.9, 1, 1, 0.9, 0.8, 3],
  ["PPS", 1, 0.7, 1, 0.8, 0.8, 0.8, 0.8, 0.9, 1, 4],
  ["mBox 360", 1, 0.9, 1, 0.9, 0.7, 0.9, 0.8, 0.9, 1, 4],
  ["Nuu", 0.8, 0.6, 0.7, 1, 0.7, 1, 1, 1, 0.7, 4],
  ["PlaySystem 3", 1, 0.9, 0.9, 1, 0.7, 0.8, 0.8, 1, 0.9, 5],
  ["grPhone", 0.8, 0.8, 0.7, 0.9, 0.7, 1, 0.9, 1, 0.6, 4],
  ["grPad", 0.8, 0.9, 0.7, 0.9, 0.9, 1, 0.9, 1, 0.6, 4],
  ["mPad", 0.7, 0.9, 0.8, 0.9, 0.7, 0.9, 0.7, 0.9, 0.8, 4],
  ["Wuu", 0.9, 0.7, 0.8, 1, 0.7, 1, 0.9, 1, 0.7, 5],
  ["OYA", 0.9, 0.7, 0.8, 0.9, 0.8, 1, 0.8, 1, 0.9, 4],
  ["mBox One", 1, 0.8, 0.9, 0.9, 0.7, 0.9, 0.7, 1, 0.8, 6],
  ["mBox Next", 0.9, 0.9, 0.9, 0.8, 0.7, 1, 0.9, 1, 0.8, 7],
  ["PlaySystem 4", 1, 0.8, 1, 0.9, 0.7, 0.9, 0.8, 1, 0.9, 6],
  ["Swap", 0.9, 0.8, 1, 0.8, 0.7, 1, 0.9, 1, 0.8, 6],
  ["PlaySystem 5", 1, 0.7, 0.9, 1, 0.7, 0.9, 0.8, 1, 0.9, 7],
  ["Custom Console[?]", 1.015, 0.98, 1.0, 0.92, 0.93, 1.02, 1.0, 1.3, 1.2, 0]
];

//								Development Focus
//						Act		Adv		RPG  	Sim  	Str  	Cas
var developmentFocus = [
  ["Engine", 1.0, 0.7, 0.7, 0.8, 0.8, 0], // Engine
  ["Gameplay", 0.8, 0.7, 0.8, 1.0, 1.0, 1.0], // Gameplay
  ["Story/Quests", 0.7, 1.0, 1.0, 0.7, 0.7, 0.7], // Story/Quests
  ["Dialogues", 0.7, 1.0, 1.0, 0.7, 0.7, 0.7], // Dialogues
  ["Level Design", 0.8, 0.7, 0.8, 0.8, 1.0, 1.0], // Level Design
  ["AI", 1.0, 0.7, 0.7, 1.0, 0.8, 0.7], // AI
  ["World Design", 0.7, 1.0, 1.0, 0, 1.0, 0.7], // World Design
  ["Graphic", 1.0, 0.8, 0.8, 1.0, 0.7, 1.0], // Graphic
  ["Sound", 0.8, 0.7, 0.7, 0.8, 0.8, 0.8] // Sound
];
...
$(document).ready(function () {
  ...
  // CREATE FIELDSET
  calcfs = $(document.createElement("fieldset"))
    .attr({ id: "calcFieldset" })
    .appendTo(calcDiv);
  $(document.createElement("h2"))
    .text("Game Dev Tycoon Calculator")
    .appendTo(calcfs);
  ...
  var checkboxTable = $(document.createElement("table"))
    .attr({ id: "checkboxTable" })
    .appendTo(checkboxDiv);

  // div for select boxes
  var selectboxDiv = $(document.createElement("div"))
    .attr({ id: "selectboxDiv" })
    .appendTo(calcfs);
  var selectboxTable = $(document.createElement("table"))
    .attr({ id: "selectboxTable" })
    .appendTo(selectboxDiv);
  ...
  var inputboxDiv = $(document.createElement("div"))
    .attr({ id: "inputboxDiv" })
    .appendTo(calcfs);
  var inputboxTable = $(document.createElement("table"))
    .attr({ id: "inputboxTable" })
    .appendTo(inputboxDiv);
  ...
  platformSelector = $(document.createElement("select"))
    .attr({ id: "platformselect" })
    .change(populateFields)
    .keyup(populateFields);
  topicSelector = $(document.createElement("select"))
    .change(populateFields)
    .keyup(populateFields);
  genre1Selector = $(document.createElement("select"))
    .change(populateFields)
    .keyup(populateFields);
  genre2Selector = $(document.createElement("select"))
    .change(populateFields)
    .keyup(populateFields);
  audienceSelector = $(document.createElement("select"))
    .change(populateFields)
    .keyup(populateFields);
  gameSizeSelector = $(document.createElement("select"))
    .change(populateFields)
    .keyup(populateFields);
  yearSelector = $(document.createElement("select"))
    .change(populateFields)
    .keyup(populateFields);
  trendSelector = $(document.createElement("select"))
    .change(populateFields)
    .keyup(populateFields);
  ...
  $("<tr></tr>")
    .append(
      $("<td></td>")
        .append($("<label></label>").html("Platform"))
        .css({ "text-align": "right" })
    )
    .append($("<td></td>").append(platformSelector).css({ width: "160px" }))
    .append(
      $("<td></td>")
        .append($("<label></label>").html("Genre 1"))
        .css({ "text-align": "right" })
        .hover(function () {
          addToNotes("genre");
        }, clearNotes)
    ...
    .append(
      $("<td></td>")
        .append(genre1Selector.css({ width: "180px" }))
        .hover(function () {
          addToNotes("genre");
        }, clearNotes)
    )
  ...
  $("<tr></tr>")
    .append(
      $("<td></td>")
        .append($("<label></label>").html("Topic"))
        .css({ "text-align": "right" })
    )
    .append($("<td></td>").append(topicSelector))
    .append(
      $("<td></td>")
        .append($("<label></label>").html("Genre 2"))
        .css({ "text-align": "right" })
        .hover(function () {
          addToNotes("genre");
        }, clearNotes)
    ...
    .append(
      $("<td></td>")
        .append(genre2Selector.css({ width: "180px" }))
        .hover(function () {
          addToNotes("genre");
        }, clearNotes)
    )
  ...
  $("<tr></tr>")
    .append(
      $("<td></td>")
        .append($("<label></label>").html("Audience"))
        .css({ "text-align": "right" })
        .hover(function () {
          addToNotes("audience");
        }, clearNotes)
    ...
    .append(
      $("<td></td>")
        .append($("<label></label>").html("Game Size"))
        .css({ "text-align": "right" })
        .hover(function () {
          addToNotes("game size");
        }, clearNotes)
    )
    .append(
      $("<td></td>")
        .append(gameSizeSelector)
        .hover(function () {
          addToNotes("game size");
        }, clearNotes)
    )
  ...
  inGarageBox = $(document.createElement("input"))
    .attr({ type: "checkbox", checked: "true" })
    .change(populateFields);

  // Checkbox asking if less than 100k fans
  lt100kFansBox = $(document.createElement("input"))
    .attr({ type: "checkbox", checked: "true" })
    .change(populateFields);

  // Checkbox asking if game is a sequel
  isSequelBox = $(document.createElement("input"))
    .attr("type", "checkbox")
    .change(populateFields);

  // Checkbox asking if game is an expansion
  isExpansionBox = $(document.createElement("input"))
    .attr("type", "checkbox")
    .change(populateFields);

  // Checkbox asking if this game is an MMO
  isMMOBox = $(document.createElement("input"))
    .attr("type", "checkbox")
    .change(populateFields);

  // Checkbox asking if this game has a new employee working on it
  newEmployeeBox = $(document.createElement("input"))
    .attr("type", "checkbox")
    .change(populateFields);
  ...
  $("<tr></tr>")
    .append(inGarageBox)
    .append($("<label></label>").html("In Garage"))
    .appendTo(checkboxTable)
    .hover(function () {
      addToNotes("in garage");
    }, clearNotes);
  $("<tr></tr>")
    .append(lt100kFansBox)
    .append($("<label></label>").html("<100k Fans"))
    .appendTo(checkboxTable)
    .hover(function () {
      addToNotes("100k fans");
    }, clearNotes);
  $("<tr></tr>")
    .append(isSequelBox)
    .append($("<label></label>").html("Sequel"))
    .appendTo(checkboxTable)
    .hover(function () {
      addToNotes("sequel");
    }, clearNotes);
  $("<tr></tr>")
    .append(isExpansionBox)
    .append($("<label></label>").html("Expansion"))
    .appendTo(checkboxTable)
    .hover(function () {
      addToNotes("expansion");
    }, clearNotes);
  $("<tr></tr>")
    .append(isMMOBox)
    .append($("<label></label>").html("MMO"))
    .appendTo(checkboxTable)
    .hover(function () {
      addToNotes("mmo");
    }, clearNotes);
  $("<tr></tr>")
    .append(newEmployeeBox)
    .append($("<label></label>").html("New Employee"))
    .appendTo(checkboxTable)
    .hover(function () {
      addToNotes("new employee");
    }, clearNotes);

  // Input box for amount of design points
  designInput = $(document.createElement("input")).attr({
    type: "text",
    size: "6",
    maxlength: "6"
  });
  ...
  scoreInput = $(document.createElement("input")).attr({
    type: "text",
    size: "6",
    maxlength: "6"
  });
  //$(scoreInput).keyup(populateFields);

  // Input box for amount of tech points
  techInput = $(document.createElement("input")).attr({
    type: "text",
    size: "6",
    maxlength: "6"
  });
  ...
  bugInput = $(document.createElement("input")).attr({
    type: "text",
    size: "6",
    maxlength: "6"
  });
  ...
  reviewScoreLabel = $(document.createElement("input"));
  $(reviewScoreLabel).attr("hidden", true);
  ...
  $("<tr></tr>")
    .append(
      $("<td></td>")
        .append($("<label></label>").html("Design"))
        .css({ "text-align": "right", "font-weight": "bold", color: "orange" })
    )
    .append($("<td></td>").append(designInput))
    .append(
      $("<td></td>")
        .append($("<label></label>").html("Target Score"))
        .css({ "text-align": "right" })
    )

    .append(
      $("<td></td>")
        .append(targetGameScoreLabel)
        .css({ width: "70px", "font-weight": "bold" })
    )
    .appendTo(inputboxTable);
  $("<tr></tr>")
    .append(
      $("<td></td>")
        .append($("<label></label>").html("Tech"))
        .css({ "text-align": "right", "font-weight": "bold", color: "blue" })
    )
    .append($("<td></td>").append(techInput).css({ width: "70px" }))

    .append(
      $("<td></td>")
        .append($("<label></label>").html("Game Score"))
        .css({ "text-align": "right" })
    )
    .append(
      $("<td></td>").append(gameScoreLabel).css({ "font-weight": "bold" })
    )
    .appendTo(inputboxTable);
  $("<tr></tr>")
    .append(
      $("<td></td>")
        .append($("<label></label>").html("Bugs"))
        .css({ "text-align": "right", "font-weight": "bold", color: "red" })
    )
    .append($("<td></td>").append(bugInput))
    .append(
      $("<td></td>")
        .append($("<label></label>").html("Review Score"))
        .css({ "text-align": "right" })
    )
    .append(reviewScoreLabel)
    .append($("<td></td>").append(scoreInput))
    .appendTo(inputboxTable);
  ...
  $("<tr></tr>")
    .append(
      $("<td></td>")
        .append($("<label></label>").html("Optimal T/D Ratio"))
        .hover(function () {
          addToNotes("optimalTD");
        }, clearNotes)
    )
    .append(
      $("<td></td>")
        .append(targetTDRatioLabel)
        .css({ width: "40px", "font-weight": "bold" })
        .hover(function () {
          addToNotes("actualTD");
        }, clearNotes)
    )
    .append(
      $("<td></td>")
        .append($("<label></label>").html("Platform / Genre"))
        .hover(function () {
          addToNotes("platform genre");
        }, clearNotes)
    )
    .append(
      $("<td></td>")
        .append(platformGenreLabel.css({ "font-weight": "bold" }))
        .hover(function () {
          addToNotes("platform genre");
        }, clearNotes)
    )
  ...
  $("<tr></tr>")
    .append(
      $("<td></td>")
        .append($("<label></label>").html("Actual T/D Ratio"))
        .hover(function () {
          addToNotes("actualTD");
        }, clearNotes)
    )
    .append(
      $("<td></td>")
        .append(actualTDRatioLabel.css({ "font-weight": "bold" }))
        .hover(function () {
          addToNotes("actualTD");
        }, clearNotes)
    )
    .append(
      $("<td></td>")
        .append($("<label></label>").html("Topic / Audience"))
        .hover(function () {
          addToNotes("topic audience");
        }, clearNotes)
    )
    .append(
      $("<td></td>")
        .append(topicAudienceLabel.css({ "font-weight": "bold" }))
        .hover(function () {
          addToNotes("topic audience");
        }, clearNotes)
    )
  ...
  $("<tr></tr>")
    .append(
      $("<td></td>")
        .append($("<label></label>").html("Game Quality"))
        .hover(function () {
          addToNotes("quality");
        }, clearNotes)
    )
    .append(
      $("<td></td>")
        .append(qualityLabel.css({ "font-weight": "bold" }))
        .hover(function () {
          addToNotes("quality");
        }, clearNotes)
    )
    .append(
      $("<td></td>")
        .append($("<label></label>").html("Topic / Genre"))
        .hover(function () {
          addToNotes("topic genre");
        }, clearNotes)
    )
    .append(
      $("<td></td>")
        .append(topicGenreLabel.css({ "font-weight": "bold" }))
        .hover(function () {
          addToNotes("topic genre");
        }, clearNotes)
    )
  ...
  $("<tr></tr>")
    .append(
      $("<td></td>")
        .append($("<label></label>").html("Sales Modifier"))
        .hover(function () {
          addToNotes("salesmod");
        }, clearNotes)
    )
    .append(
      $("<td></td>")
        .append(salesModifierLabel.css({ "font-weight": "bold" }))
        .hover(function () {
          addToNotes("salesmod");
        }, clearNotes)
    )
  ...
  $("<tr></tr>")
    .append(
      $("<td></td>")
        .append($(saveGamesButton))
        .hover(function () {
          addToNotes("save old games");
        }, clearNotes)
    )
    .append(
      $("<td></td>")
        .append($(clearLastButton))
        .hover(function () {
          addToNotes("clear last old game");
        }, clearNotes)
    )
  ...
  $("<tr></tr>")
    .append(
      $("<td></td>")
        .append($(loadGamesButton))
        .hover(function () {
          addToNotes("load old games");
        }, clearNotes)
    )
    .append(
      $("<td></td>")
        ...
        .hover(function () {
          addToNotes("clear all old games");
        }, clearNotes)
    )
    .appendTo(buttonsTable);
  ...
  oldGamesHeaderDiv = $(document.createElement("div"))
    .attr({ id: "oldGamesDivHeader" })
    .appendTo(oldGamesDiv);
  oldGamesTableDiv = $(document.createElement("div"))
    .attr({ id: "oldGamesDiv" })
    .appendTo(oldGamesDiv);

  oldGamesTable = $("<table></table>")
    .attr({ id: "oldGamesTable" })
    .appendTo(oldGamesTableDiv);

  $("<table></table>")
    .attr({ id: "oldGamesTableHeader" })
    .append(
      $("<tr></tr>")
        .append(
          $("<td></td>")
            .append($("<label></label>").html("No."))
            .css("width", "35px")
        )
        .append(
          $("<td></td>")
...
function updateGameAndReviewScore() {
  ...
  if (
    selTopic == prevTopic &&
    selGenre1 == prevGenre1 &&
    selGenre2 == prevGenre2 &&
    !isSequelBox.is(":checked") &&
    !isExpansionBox.is(":checked")
  ) {
    q -= 0.4;
    sameAsLast = true;
  ...
  if (
    $(isMMOBox).is(":checked") &&
    (topics[selTopic][selGenre1 + 1] < 1 ||
      (selGenre2 != 6 && topics[selTopic][selGenre2 + 1] < 1))
  ) {
    q -= 0.15;
  }
  ...
  var platGenreVal =
    platforms[parseInt($(platformSelector).val())][selGenre1 + 1];
  if (selGenre2 != 6)
    platGenreVal =
      (platGenreVal * 2) / 3 +
      platforms[parseInt($(platformSelector).val())][selGenre2 + 1] / 3;

  setBadOkGoodText(platformGenreLabel, platGenreVal);

  // TOPIC/AUDIENCE COMBINATION VALUE
  var topicAudienceVal =
    topics[$(topicSelector).val()][parseInt($(audienceSelector).val()) + 7];
  ...
  if ($(gameSizeSelector).val() == 0 && !$(inGarageBox).is(":checked"))
    technicalExpertise = 9;
  if ($(gameSizeSelector).val() == 1 && $(lt100kFansBox).is(":checked"))
    technicalExpertise = 9;
  // large game
  if ($(gameSizeSelector).val() == 2) {
    // going to assume engine tech level > 2D v4 or 3D v3
    var k = 3 - platforms[$(platformSelector).val()][10];
    if ($(platformSelector).val() == 0 || $(platformSelector).val() == 29)
      k = 0;
    if (k < 0) k = 0;
  ...
  if ($(gameSizeSelector).val() == 3) {
    ...
    if ($(platformSelector).val() == 0 || $(platformSelector).val() == 25)
      k = 0;
    if (k < 0) k = 0;
    if (k > 3) k = 3;
  ...
  // new employee or low quality
    ...
    if (q < 1.1 || $(newEmployeeBox).is(":checked")) {
      $(reviewScoreLabel).html("8.85");
      finalScore = 8.85;
    } else $(reviewScoreLabel).html(reviewScore.toFixed(2));
  } else {
    newTopScoreSet = false;

    //$(reviewScoreLabel).val(finalScore.toFixed());
  }
  clearNotes();
  $(scoreInput).val(finalScore.toFixed(2));
}
...
function drawSliders() {
  for (var i = 0; i < 9; i++) {
    ...
    if ($(genre2Selector).val() != 6)
      x =
        (x * 2) / 3 +
        developmentFocus[i][parseInt($(genre2Selector).val()) + 1] / 3;
    var absX = x;
    x = x >= 0.9 ? 4 : x < 0.79 ? 0 : 3;

    sliderTabs[i].css({ top: -642 + 2 * i - i * sliderDivHeight - x * 20 });
    // sliderTabs[i].html(absX.toFixed(2));
    var c =
      i % 3 == 0
        ? "cyanSliderTrack"
        : i % 3 == 1
        ? "darkGreenSliderTrack"
        : "greenSliderTrack";
...
function populateFields() {
  ...
  for (var i = 0; i < platforms.length; i++)
    $(platformSelector).append(new Option(platforms[i][0], i));
  ...
  for (var i = 0; i < topics.length; i++)
    $(topicSelector).append(new Option(topics[i][0], i));
  ...
  for (var i = 0; i < genres.length - 1; i++) {
    $(genre1Selector).append(
      new Option(
        genres[i] +
          " (" +
          getBadOkGoodText(platforms[$(platformSelector).val()][i + 1]) +
          "|" +
          getBadOkGoodText(topics[$(topicSelector).val()][i + 1]) +
          ")",
        i
      )
    );
  ...
  $(audienceSelector).append(
    new Option(
      "Young    (" + getBadOkGoodText(topics[$(topicSelector).val()][7]) + ")",
      0
    )
  );
  $(audienceSelector).append(
    new Option(
      "Everyone (" + getBadOkGoodText(topics[$(topicSelector).val()][8]) + ")",
      1
    )
  );
  $(audienceSelector).append(
    new Option(
      "Mature   (" + getBadOkGoodText(topics[$(topicSelector).val()][9]) + ")",
      2
    )
  );
  ...
  salesModifierLabel.html(
    platforms[$(platformSelector).val()][
      parseInt(audienceSelector.val()) + 7
    ].toFixed(2)
  );
...
function gameFinished() {
  ...
  $("<tr></tr>")
    .append(
      $("<td></td>")
        .append($("<label></label>").html(gameNumber))
        .css("width", "35px")
    )
    .append(
      $("<td></td>")
        .append(
          $("<label></label>").html(platforms[$(platformSelector).val()][0])
        )
        .css("width", "95px")
    )
    .append(
      $("<td></td>")
        .append($("<label></label>").html(topics[$(topicSelector).val()][0]))
        .css("width", "90px")
    )
    .append(
      $("<td></td>")
        .append(
          $("<label></label>").html(
            genres[$(genre1Selector).val()] +
              "<br />" +
              genres[$(genre2Selector).val()]
          )
        )
        .css("width", "80px")
    )
    .append(
      $("<td></td>")
        .append($("<label></label>").html(audiences[$(audienceSelector).val()]))
        .css("width", "70px")
    )
    .append(
      $("<td></td>")
        .append($("<label></label>").html(gameSizes[$(gameSizeSelector).val()]))
        .css("width", "60px")
    )
    .append(
      $("<td></td>")
        .append($("<label></label>").html(years[$(yearSelector).val()]))
        .css("width", "35px")
    )
    .append(
      $("<td></td>")
        .append($("<label></label>").html($(techInput).val()))
        .css("width", "60px")
    )
    .append(
      $("<td></td>")
        .append($("<label></label>").html($(designInput).val()))
        .css("width", "60px")
    )
    .append(
      $("<td></td>")
        .append($("<label></label>").html($(bugInput).val()))
        .css("width", "60px")
    )
    .append(
      $("<td></td>")
        .append($("<label></label>").html($(gameScoreLabel).html()))
        .css("width", "80px")
    )
    .append(
      $("<td></td>")
        .append($("<label></label>").html($(scoreInput).val()))
        .css("width", "55px")
    )
  ...
  oldGames.push({
    ...
    reviewScore: $(scoreInput).val(),
    topScore: topScore,
    numTopScores: numTopScores,
    targetScore: targetGameScore
  });
  console.log("scoreinput", $(scoreInput).val());
...
function saveOldGames() {
  ...
  window.localStorage.removeItem("oldGames");
  var data = [];
  for (var i = 0; i < 50 && i < oldGames.length; i++)
    data.unshift(oldGames[oldGames.length - i - 1]);

  //$.cookie("oldGames", JSON.stringify(data), { expires: 45 });
  window.localStorage.setItem("oldGames", JSON.stringify(data));
}

// load old games from cookie
function loadOldGames() {
  var old = window.localStorage.getItem("oldGames");
  if (old == undefined) return;
  clearAllOldGames();

  oldGames = JSON.parse(old);

  for (var i = 0; i < oldGames.length; i++) {
    $("<tr></tr>")
      .append(
        $("<td></td>")
          .append($("<label></label>").html(oldGames[i].gameNumber))
          .css("width", "35px")
      )
      .append(
        $("<td></td>")
          .append($("<label></label>").html(platforms[oldGames[i].platform][0]))
          .css("width", "95px")
      )
      .append(
        $("<td></td>")
          .append($("<label></label>").html(topics[oldGames[i].topic][0]))
          .css("width", "90px")
      )
      .append(
        $("<td></td>")
          .append(
            $("<label></label>").html(
              genres[oldGames[i].genre1] + "<br />" + genres[oldGames[i].genre2]
            )
          )
          .css("width", "80px")
      )
      .append(
        $("<td></td>")
          .append($("<label></label>").html(audiences[oldGames[i].audience]))
          .css("width", "70px")
      )
      .append(
        $("<td></td>")
          .append($("<label></label>").html(gameSizes[oldGames[i].gameSize]))
          .css("width", "60px")
      )
      .append(
        $("<td></td>")
          .append($("<label></label>").html(years[oldGames[i].years]))
          .css("width", "35px")
      )
      .append(
        $("<td></td>")
          .append($("<label></label>").html(oldGames[i].designInput))
          .css("width", "60px")
      )
      .append(
        $("<td></td>")
          .append($("<label></label>").html(oldGames[i].techInput))
          .css("width", "60px")
      )

      .append(
        $("<td></td>")
          .append($("<label></label>").html(oldGames[i].bugInput))
          .css("width", "60px")
      )
      .append(
        $("<td></td>")
          .append($("<label></label>").html(oldGames[i].gameScore))
          .css("width", "80px")
      )
      .append(
        $("<td></td>")
          .append($("<label></label>").html(oldGames[i].reviewScore))
          .css("width", "55px")
      )
      .prependTo(oldGamesTable);
  }
...
function addToNotes(s) {
  ...
  switch (s) {
    ...
    case "in garage":
      notesDiv.append(
        $(
          '<p style="font-weight: bold">In Garage</p>' +
    ...
    case "100k fans":
      notesDiv.append(
        $(
          '<p style="font-weight: bold">Less Than 100k Fans</p>' +
    ...
    case "sequel":
      notesDiv.append(
        $(
          '<p style="font-weight: bold">Sequel</p>' +
    ...
    case "mmo":
      notesDiv.append(
        $(
          '<p style="font-weight: bold">MMO</p>' +
    ...
    case "new employee":
      notesDiv.append(
        $(
          '<p style="font-weight: bold">New Employee</p>' +
    ...
    case "game size":
      notesDiv.append(
        $(
          '<p style="font-weight: bold">Game Size</p>' +
    ...
    case "optimalTD":
      notesDiv.append(
        $(
          '<p style="font-weight: bold">Optimal Tech / Design Ratio</p>' +
    ...
    case "actualTD":
      notesDiv.append(
        $(
          '<p style="font-weight: bold">Actual Tech / Design Ratio</p>' +
    ...
    case "quality":
      notesDiv.append(
        $(
          '<p style="font-weight: bold">Game Quality Factor</p>' +
    ...
    case "salesmod":
      notesDiv.append(
        $(
          '<p style="font-weight: bold">Sales Modifier</p>' +
    ...
    case "platform genre":
      notesDiv.append(
        $(
          '<p style="font-weight: bold">Platform / Genre Factor</p>' +
    ...
    case "topic audience":
      notesDiv.append(
        $(
          '<p style="font-weight: bold">Topic / Audience Factor</p>' +
            "<p>Directly affects Game Score.</p>"
        )
      );
      break;
    case "topic genre":
      notesDiv.append(
        $(
          '<p style="font-weight: bold">Topic / Genre Factor</p>' +
    ...
    case "sliders":
      notesDiv.append(
        $(
          '<p style="font-weight: bold">Sliders</p>' +
    ...
    case "clear last old game":
      notesDiv.append(
        $(
          '<p style="font-weight: bold">Clear Last Game</p>' +
    ...
    case "clear all old games":
      notesDiv.append(
        $(
          '<p style="font-weight: bold">Clear All Games</p>' +
    ...
    case "save old games":
      notesDiv.append(
        $(
          '<p style="font-weight: bold">Save Games List</p>' +
            "<p>Stores the last max 50 games in your games list on your browsers localStorage.</p>"
        )
      );
      break;
    case "load old games":
      notesDiv.append(
        $(
          '<p style="font-weight: bold">Load Games List</p>' +
...
function clearNotes() {
  $(notesDiv).empty();
  if (sameAsLast)
    notesDiv.append($("<p><b>Warning: game is identical to previous.</b></p>"));
}
